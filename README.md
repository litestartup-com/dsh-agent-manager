...
# pros: curl -fsSL https://raw.githubusercontent.com/litestartup-com/dsh-agent-manager/v1.1.0/install.sh | bash
```
...
# pros: irm https://raw.githubusercontent.com/litestartup-com/dsh-agent-manager/v1.1.0/install.ps1 | iex
```
