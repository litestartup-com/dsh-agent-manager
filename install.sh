...
#   # one-liner for the impatient: curl -fsSL https://raw.githubusercontent.com/litestartup-com/dsh-agent-manager/v1.1.1/install.sh | bash
#
...
APP_DIR="${APP_DIR:-.}"
OHDSH_VERSION="${OHDSH_VERSION:-v1.1.1}"
