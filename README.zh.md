...
# 熟手一行：curl -fsSL https://raw.githubusercontent.com/litestartup-com/dsh-agent-manager/v1.1.0/install.sh | bash
```
...
# 熟手一行：irm https://raw.githubusercontent.com/litestartup-com/dsh-agent-manager/v1.1.0/install.ps1 | iex
```
