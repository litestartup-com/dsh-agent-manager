...
#
# 推荐（先下载查看再执行）：
#   irm https://raw.githubusercontent.com/litestartup-com/dsh-agent-manager/v1.0.4/install.ps1 -OutFile install.ps1
#   powershell -ExecutionPolicy Bypass -File .\install.ps1
# 熟手一行（直接执行，参数不可传）：
#   irm https://raw.githubusercontent.com/litestartup-com/dsh-agent-manager/v1.0.4/install.ps1 | iex
#
